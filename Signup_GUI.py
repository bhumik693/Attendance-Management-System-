...
class Sign:
    def database_create(self):
        if(self.pass_word.get()==self.re_pass_word.get()):
            ...
            # self.query_database = f"CREATE DATABASE {self.user_name.get()}"
            ...
            # try:
            #     # self.cur.execute(self.query_database)
            #     # self.cur.commit()
            #     msg.showinfo("Login","Registered Successfully")
            # except:
            #     msg.showwarning("Message", "Database already created")
